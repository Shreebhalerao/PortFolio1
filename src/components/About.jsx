...
const About = () => (
    <section id="about" className="-mt-10 bg-gray-950">
        <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-4xl font-bold text-center mb-10 text-gray-100">
                About <span className="text-amber-300">Me</span>
            </h2>
            <div className="bg-gray-950 p-8 rounded-xl shadow-2xl shadow-amber-900/50 border border-amber-600/50">
                
                {/* Two-Column Layout for About Content */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    
                    {/* Left Column: Condensed Info (max 6 lines) */}
                    ...
                    <div className="flex flex-col items-center md:items-start space-y-4 pt-4 md:pt-0 border-t md:border-t-0 md:border-l border-amber-600/30 md:pl-8">
                        <h3 className="text-xl font-semibold text-amber-300 mb-4">Connect with Me</h3>
                        
                        {/* New: Resume Download Link (Styled like a social link) */}
                        <a 
                            href={resume} // REMEMBER TO REPLACE THIS URL
                            download="Shreeraj_Bhalerao_Resume.pdf" // Sets the downloaded file name
                            className="flex items-center space-x-3 text-gray-200 hover:text-amber-300 transition duration-300 group"
                        >
                            <DownloadIcon className="w-8 h-8 text-amber-500 group-hover:text-amber-300"/>
                            <span className="text-lg font-medium">Resume (Download PDF)</span>
                        </a>
                        ...
                        <a href="https://www.linkedin.com/in/shreeraj-bhalerao-4bb096294/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-gray-200 hover:text-amber-300 transition duration-300 group">
                            <LinkedinIcon className="w-8 h-8 text-amber-500 group-hover:text-amber-300"/>
                            <span className="text-lg font-medium">LinkedIn (Professional)</span>
                        </a>
                        ...
                        <a href="https://github.com/Shreebhalerao" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-gray-200 hover:text-amber-300 transition duration-300 group">
                            <GithubIcon className="w-8 h-8 text-amber-500 group-hover:text-amber-300"/>
                            <span className="text-lg font-medium">GitHub (Code)</span>
                        </a>
                        ...
                        <a href="https://instagram.com/yourprofile" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-gray-200 hover:text-amber-300 transition duration-300 group">
                            <InstagramIcon className="w-8 h-8 text-amber-500 group-hover:text-amber-300"/>
                            <span className="text-lg font-medium">Instagram (Personal)</span>
                        </a>
                    </div>
